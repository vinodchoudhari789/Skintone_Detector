...
def skinToneProcess():
    ...
    url="https://raw.githubusercontent.com/octalpixel/Skin-Extraction-from-Image-and-Finding-Dominant-Color/master/82764696-open-palm-hand-gesture-of-male-hand_image_from_123rf.com.jpg"
    pil_img = Image.open(ImageModel.objects.last().cover).convert('RGB')
    open_cv_image = numpy.array(pil_img) 
    #print(type(img))
    open_cv_image = open_cv_image[:, :, ::-1].copy()
    image = open_cv_image
    #image = cv2.imread(r"E:\Dataset\0004.jpg")
    #print(image)
